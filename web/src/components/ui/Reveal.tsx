...
export default function Reveal({
  ...
  useEffect(() => {
    ...
    // Safety net: content starts at opacity 0, so if the observer never
    // reports (it can be unavailable or inert in some embedded/automation
    // browsers, and a very tall element can never reach `threshold`), the
    // page would stay permanently blank. Reveal it regardless after a beat --
    // in a normal browser the observer wins long before this fires.
